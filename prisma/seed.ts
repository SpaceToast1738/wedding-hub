...
async function seedBookSections() {
  ...
  // legacy slugs (`wedding-party`, `venue`, `ceremony`,
  ...
  const sections = [
    ...
    // v2.0.0: legal-before / legal-day / legal-after sections + their
    // LEGAL-kind cards (Notice of Marriage, marriage certificate, etc.)
    // dropped — UK-marriage-law-centric. Legacy section slugs left
    // unreserved so future custom sections can claim them.
...
async function main() {
  ...
  // v2.0.0: seedLegalSections retired with the LEGAL card kind
  // (was UK-marriage-law-centric — Notice of Marriage, marriage
  // certificate pickup, etc.).
