...
const STATUS_CLASSES: Record<Status, string> = {
  ...
  PENDING:   "bg-marigold-100 text-marigold-700 border-marigold-200 dark:border-marigold-700",
  BOOKED:    "bg-moss-50 text-moss-700 border-moss-100",
  PAID:      "bg-info-bg text-info border-info-border dark:bg-muted dark:border-border-soft",
  LEAD:      "bg-marigold-100 text-marigold-700 border-marigold-200 dark:border-marigold-700",
  DECLINED:  "bg-danger-bg text-danger border-danger-border",
  TODO:      "bg-muted text-ink-secondary border-border-soft",
  DOING:     "bg-marigold-100 text-marigold-700 border-marigold-200 dark:border-marigold-700",
  DONE:      "bg-moss-50 text-moss-700 border-moss-100",
  SCHEDULED: "bg-marigold-100 text-marigold-700 border-marigold-200 dark:border-marigold-700",
  OVERDUE:   "bg-danger-bg text-danger border-danger-border",
  HIGH:      "bg-danger-bg text-danger border-danger-border",
  MED:       "bg-marigold-100 text-marigold-700 border-marigold-200 dark:border-marigold-700",
  LOW:       "bg-moss-50 text-moss-700 border-moss-100",
  ADULT:     "bg-muted text-ink-secondary border-border-soft",
  CHILD:     "bg-marigold-100 text-marigold-700 border-marigold-200 dark:border-marigold-700",
};
