...
export function formatAuditAction(row: AuditRow): string {
  ...
  // v2.0.0: LEGAL card audit handlers (legal-save / legal-file-attach
  // / legal-file-detach) retired with the LEGAL card kind. Historical
  // audit rows that reference these actions still survive in the DB
  // and fall through to the default "unrecognised action" render at
