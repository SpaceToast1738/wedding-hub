...
export const proposeTask: AiTool<typeof inputSchema> = {
  name: "propose_task",
  description:
    "Propose a new task for the couple to review. **This does NOT create the task** — it writes a proposal that the couple will Apply, Edit, or Dismiss in the review panel. Include a rationale so they understand why. Call this once per distinct task you want to add; do not batch several in one call.",
  inputSchema,
